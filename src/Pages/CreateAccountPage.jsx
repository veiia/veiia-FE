...
import '../Styles/_CreateAccountPage.css'
  ...
  return (
    <div>
      <div className='container container-login'>
        ...
        <div>
          <p>Вы можете зарегистрироваться одним из следующих способов:</p>
          <button name='gitHub' className='gitHub-login-button'>
            <img src={gitHubLogo} alt="" />
            <span className='button-text'>GitHub
            </span>
          </button>
          <Link className='email-login-button' to='/create-account-with-email'>Email</Link>
        </div>
      </div>
    </div>
  )
